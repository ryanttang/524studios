...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getRequestHost, getRequestProtocol, createError, getQuery as getQuery$1, removeResponseHeader, setHeader, getHeader, getResponseStatus, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, sendError, getResponseStatusText, H3Error } from 'file:///Users/ryantang/524studios/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/ryantang/524studios/node_modules/@vue/shared/dist/shared.cjs.js';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/ryantang/524studios/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///Users/ryantang/524studios/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///Users/ryantang/524studios/node_modules/image-size/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutTrailingSlash, withLeadingSlash, withBase, withoutProtocol, withoutLeadingSlash, decodePath, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/ryantang/524studios/node_modules/ufo/dist/index.mjs';
import consola, { consola as consola$1, createConsola } from 'file:///Users/ryantang/524studios/node_modules/consola/dist/index.mjs';
...
import { isVNode, toValue, isRef } from 'file:///Users/ryantang/524studios/node_modules/vue/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/ryantang/524studios/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse, uneval } from 'file:///Users/ryantang/524studios/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/ryantang/524studios/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/ryantang/524studios/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/ryantang/524studios/node_modules/unstorage/drivers/lru-cache.mjs';
import destr, { destr as destr$1 } from 'file:///Users/ryantang/524studios/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/ryantang/524studios/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/ryantang/524studios/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/ryantang/524studios/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/ryantang/524studios/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/ryantang/524studios/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/ryantang/524studios/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/ryantang/524studios/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/ryantang/524studios/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/ryantang/524studios/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file:///Users/ryantang/524studios/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/ryantang/524studios/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/ryantang/524studios/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/ryantang/524studios/node_modules/errx/dist/index.js';
import devalue from 'file:///Users/ryantang/524studios/node_modules/@nuxt/devalue/dist/devalue.mjs';
import fs, { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file:///Users/ryantang/524studios/node_modules/pathe/dist/index.mjs';
import Fuse from 'file:///Users/ryantang/524studios/node_modules/fuse.js/dist/fuse.mjs';
import { diffLines } from 'file:///Users/ryantang/524studios/node_modules/diff/libesm/index.js';
import MagicString from 'file:///Users/ryantang/524studios/node_modules/magic-string/dist/magic-string.es.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/ryantang/524studios/node_modules/unhead/dist/plugins.mjs';
import { renderToString } from 'file:///Users/ryantang/524studios/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/ryantang/524studios/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/ryantang/524studios/node_modules/ipx/dist/index.mjs';
import { createGenerator } from 'file:///Users/ryantang/524studios/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/ryantang/524studios/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///Users/ryantang/524studios/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///Users/ryantang/524studios/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/ryantang/524studios/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/ryantang/524studios/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"/Users/ryantang/524studios/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ryantang/524studios","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ryantang/524studios/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ryantang/524studios/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ryantang/524studios/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ryantang/524studios/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "nuxt-link-checker": {
      ...
      "rootDir": "/Users/ryantang/524studios",
      "excludeLinks": [],
      "skipInspections": [],
      "fetchTimeout": 10000,
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/ryantang/524studios/public"
      ]
    },
    "http": {
      "domains": []
...
const _MfqVj0lgX9QKGJsWyHZ8YnH9mwRPpPRBYbEsCiyzuU = (function(nitro) {
...
const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"manifest","href":"/site.webmanifest"},{"rel":"canonical","href":"https://fivetwentyfourstudios.com"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"FiveTwentyFour Studios is a boutique web & marketing agency specializing in modern, minimal, and stylish websites that help businesses grow."},{"name":"format-detection","content":"telephone=no"},{"name":"theme-color","content":"#0ea5e9"},{"name":"msapplication-TileColor","content":"#0ea5e9"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"},{"property":"og:type","content":"website"},{"property":"og:site_name","content":"FiveTwentyFour Studios"},{"property":"og:title","content":"FiveTwentyFour Studios - Boutique Web & Marketing Agency"},{"property":"og:description","content":"Boutique web & marketing agency specializing in modern, minimal, and stylish websites that help businesses grow."},{"property":"og:image","content":"https://fivetwentyfourstudios.com/og-image.jpg"},{"property":"og:url","content":"https://fivetwentyfourstudios.com"},{"property":"og:locale","content":"en_US"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:site","content":"@fivetwentyfour"},{"name":"twitter:title","content":"FiveTwentyFour Studios - Boutique Web & Marketing Agency"},{"name":"twitter:description","content":"Boutique web & marketing agency specializing in modern, minimal, and stylish websites that help businesses grow."},{"name":"twitter:image","content":"https://fivetwentyfourstudios.com/og-image.jpg"}],"style":[],"script":[{"type":"application/ld+json","innerHTML":"{\"@context\":\"https://schema.org\",\"@type\":\"Organization\",\"name\":\"FiveTwentyFour Studios\",\"description\":\"Boutique web & marketing agency specializing in modern, minimal, and stylish websites that help businesses grow.\",\"url\":\"https://fivetwentyfourstudios.com\",\"logo\":\"https://fivetwentyfourstudios.com/logo.png\",\"sameAs\":[\"https://twitter.com/fivetwentyfour\",\"https://linkedin.com/company/fivetwentyfour\",\"https://instagram.com/fivetwentyfour\"],\"contactPoint\":{\"@type\":\"ContactPoint\",\"telephone\":\"+1-555-0123\",\"contactType\":\"customer service\",\"areaServed\":\"US\",\"availableLanguage\":\"English\"},\"address\":{\"@type\":\"PostalAddress\",\"addressCountry\":\"US\"},\"service\":[{\"@type\":\"Service\",\"name\":\"Web Design\",\"description\":\"Modern, responsive web design services\"},{\"@type\":\"Service\",\"name\":\"Brand Strategy\",\"description\":\"Comprehensive brand strategy and identity design\"},{\"@type\":\"Service\",\"name\":\"Marketing Support\",\"description\":\"Digital marketing and growth strategy services\"}]}"}],"noscript":[],"title":"FiveTwentyFour Studios - Boutique Web & Marketing Agency","htmlAttrs":{}};
...
const _t3gC9nQhZQrX0_SH8UNcr0Z_ZZAAlwXdQhQPWJcF_cE = (nitroApp) => {
...
const _BD9dbLX_jhEFRqVwIgp5Kqi4QUNmcXCgpJzBfcjEJg = defineNitroPlugin(async (nitroApp) => {
...
const _V0Rq6yneJgjP4zOzsQM8zJPa2saBL2SiWDoO60CQOxE = defineNitroPlugin(async (nitroApp) => {
...
const theme = {"fontFamily":{"sans":["Helvetica Neue","Helvetica","Arial","system-ui","sans-serif"],"display":["Helvetica Neue","Helvetica","Arial","system-ui","sans-serif"],"body":["-apple-system","BlinkMacSystemFont","Segoe UI","Roboto","system-ui","sans-serif"]},"colors":{"primary":{"50":"#f0f9ff","100":"#e0f2fe","200":"#bae6fd","300":"#7dd3fc","400":"#38bdf8","500":"#0ea5e9","600":"#0284c7","700":"#0369a1","800":"#075985","900":"#0c4a6e"},"gray":{"50":"#f9fafb","100":"#f3f4f6","200":"#e5e7eb","300":"#d1d5db","400":"#9ca3af","500":"#6b7280","600":"#4b5563","700":"#374151","800":"#1f2937","900":"#111827"}},"animation":{"fade-in":"fadeIn 0.6s ease-out","slide-up":"slideUp 0.6s ease-out","slide-in-left":"slideInLeft 0.6s ease-out","slide-in-right":"slideInRight 0.6s ease-out"},"keyframes":{"fadeIn":{"0%":{"opacity":"0"},"100%":{"opacity":"1"}},"slideUp":{"0%":{"transform":"translateY(30px)","opacity":"0"},"100%":{"transform":"translateY(0)","opacity":"1"}},"slideInLeft":{"0%":{"transform":"translateX(-30px)","opacity":"0"},"100%":{"transform":"translateX(0)","opacity":"1"}},"slideInRight":{"0%":{"transform":"translateX(30px)","opacity":"0"},"100%":{"transform":"translateX(0)","opacity":"1"}}}};
...
const componentNames = [{"hash":"TSsLEaYSNHiOdoSDkuHyg0tffqUe7fxSs-0dEDiwBuw","pascalName":"BrandedLogoDVue","kebabName":"branded-logo-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"uLI51ek65D2H9ANn1bo-U4Sz9agbfBAuaVWpejfq2cI","pascalName":"FrameDVue","kebabName":"frame-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.d.vue.ts","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"KY4HdN0ICr8Fetf79gWEytJ3i4uNQDJJUcnlxKtKDr4","pascalName":"NuxtDVue","kebabName":"nuxt-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.d.vue.ts","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"P-MXBD4anUhDUGpeI7NDfl81Z2uyyiGPidJS2NHymPA","pascalName":"NuxtSeoDVue","kebabName":"nuxt-seo-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.d.vue.ts","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"KY4HdN0ICr8Fetf79gWEytJ3i4uNQDJJUcnlxKtKDr4","pascalName":"PergelDVue","kebabName":"pergel-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.d.vue.ts","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"iV-6cePv5ka0uLfeLNbb5ZtIIggID-5d4v-asMzXuSc","pascalName":"SimpleBlogDVue","kebabName":"simple-blog-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.d.vue.ts","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"DyqwkTE9c6-GRC7AJjw7vd99zMPNwt5L6VzDDLBZ5S0","pascalName":"UnJsDVue","kebabName":"un-js-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.d.vue.ts","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"wV8blmc9tIdHoj1aylO8PlSvEGKMji3BRzVS68KDVA0","pascalName":"WaveDVue","kebabName":"wave-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"sA3J89dfCZp-NHqCifUrYcOAHzCk9yi5v2VXIYwz2Hs","pascalName":"WithEmojiDVue","kebabName":"with-emoji-d-vue","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"},{"hash":"njH1LfLeLtVueHOae-tZt-swReEVOPXDLsV8PnrbkME","pascalName":"OgImage","kebabName":"og-image","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/OgImage/OgImage.js","category":"app"},{"hash":"NzCotdygpoQ3qU3xklHxt0cgQRgGOF6UB9WxxAvQz4U","pascalName":"OgImageScreenshot","kebabName":"og-image-screenshot","path":"/Users/ryantang/524studios/node_modules/nuxt-og-image/dist/runtime/app/components/OgImage/OgImageScreenshot.js","category":"app"}];
...
const _JtqaRFgcHyo3iQtgvKCKwh9sb7bM7t1iHgVJGAUr4 = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _MfqVj0lgX9QKGJsWyHZ8YnH9mwRPpPRBYbEsCiyzuU,
_t3gC9nQhZQrX0_SH8UNcr0Z_ZZAAlwXdQhQPWJcF_cE,
_BD9dbLX_jhEFRqVwIgp5Kqi4QUNmcXCgpJzBfcjEJg,
_V0Rq6yneJgjP4zOzsQM8zJPa2saBL2SiWDoO60CQOxE,
_JtqaRFgcHyo3iQtgvKCKwh9sb7bM7t1iHgVJGAUr4
];
...
const _Y_Wm1x = eventHandler((event) => {
...
const _4flyoB = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _hWj5Pp = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/ryantang/524studios/node_modules/fast-xml-parser/src/fxp.js');
...
const _eUkO4W = defineEventHandler(async (e) => {
...
const _1QyW9f = defineEventHandler(async (e) => {
...
const _dXP1Wl = defineEventHandler(async (e) => {
...
const _gfUvO0 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _9lOKbD = defineEventHandler(async (e) => {
...
const _d_dy9W = defineEventHandler(async (e) => {
...
const _DfKQKu = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _FIKbpC = defineEventHandler(async (e) => {
...
const _BiGtXP = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _b7aVnK = defineEventHandler(async (e) => {
  return {
...
const _acD7Qj = defineEventHandler(async (e) => {
  const nitroOrigin = useNitroOrigin(e);
  return {
    nitroOrigin,
...
const _Ulxu3d = defineEventHandler(async (e) => {
...
const getServerEntry = () => import('file:///Users/ryantang/524studios/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/ryantang/524studios/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _vwYM6o = lazyEventHandler(() => {
...
const _lazy_9a6Wq1 = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_RKLCO7 = () => Promise.resolve().then(function () { return font$1; });
const _lazy_XGjsRx = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_Q2asS5 = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '', handler: _Y_Wm1x, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_9a6Wq1, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _4flyoB, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _hWj5Pp, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _eUkO4W, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _1QyW9f, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _dXP1Wl, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _gfUvO0, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _9lOKbD, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _d_dy9W, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _DfKQKu, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _FIKbpC, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _BiGtXP, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _b7aVnK, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_RKLCO7, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_XGjsRx, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_Q2asS5, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_Q2asS5, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _acD7Qj, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Ulxu3d, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _vwYM6o, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9a6Wq1, lazy: true, middleware: false, method: undefined }
];

import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, shallowReactive, defineAsyncComponent, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, computed, toValue, mergeProps, getCurrentScope, watch, useSSRContext } from 'file:///Users/ryantang/524studios/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/ryantang/524studios/node_modules/ofetch/dist/node.mjs';
import { x as headSymbol, y as useHead$1, z as baseURL, A as useSeoMeta$1, B as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///Users/ryantang/524studios/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/ryantang/524studios/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/ryantang/524studios/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/ryantang/524studios/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/ryantang/524studios/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/ryantang/524studios/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withoutTrailingSlash, withTrailingSlash, parseURL, withoutBase, stringifyQuery, withLeadingSlash, withBase } from 'file:///Users/ryantang/524studios/node_modules/ufo/dist/index.mjs';
import { InferSeoMetaPlugin } from 'file:///Users/ryantang/524studios/node_modules/@unhead/addons/dist/index.mjs';
import { TemplateParamsPlugin } from 'file:///Users/ryantang/524studios/node_modules/unhead/dist/plugins.mjs';
import { titleCase, camelCase } from 'file:///Users/ryantang/524studios/node_modules/scule/dist/index.mjs';
import { defineWebSite, defineWebPage, SchemaOrgUnheadPlugin } from 'file:///Users/ryantang/524studios/node_modules/@unhead/schema-org/dist/vue.mjs';
import { parse, stringify } from 'file:///Users/ryantang/524studios/node_modules/devalue/index.js';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/ryantang/524studios/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CDSPSvi-.mjs')
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  const path = joinURL("/", baseURL2, `__og-image__/${"static" }`, pagePath, `og.${extension}`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DMoZssTJ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bw69rKhv.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BKzzlfre.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, createError as c, useRequestEvent as d, entry$1 as default, useRouter as e, nuxtLinkDefaults as f, useOgImageRuntimeConfig as g, useSiteConfig as h, injectHead as i, navigateTo as n, resolveRouteObject as r, useHead as u };

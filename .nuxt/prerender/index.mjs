import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { K as closePrerenderer, J as localFetch } from './chunks/nitro/nitro.mjs';

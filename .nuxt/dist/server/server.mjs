import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, defineComponent, createElementBlock, provide, cloneVNode, h, isRef, isShallow, isReactive, toRaw, computed, unref, toValue, watch, ref, Suspense, Fragment, mergeProps, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/ryantang/524studios/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/ryantang/524studios/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/ryantang/524studios/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/Users/ryantang/524studios/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/ryantang/524studios/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, withTrailingSlash, withoutBase, stringifyQuery } from "/Users/ryantang/524studios/node_modules/ufo/dist/index.mjs";
import "/Users/ryantang/524studios/node_modules/klona/dist/index.mjs";
import { headSymbol, useHead as useHead$1, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/Users/ryantang/524studios/node_modules/@unhead/vue/dist/index.mjs";
...
import { stringify, parse } from "/Users/ryantang/524studios/node_modules/devalue/index.js";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CDSPSvi-.js")
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  const path = joinURL("/", baseURL2, `__og-image__/${import.meta.prerender ? "static" : "image"}`, pagePath, `og.${extension}`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DMoZssTJ.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bw69rKhv.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-BKzzlfre.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();

      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#about" class="text-gray-400 hover:text-white transition-colors duration-200 font-body">About</a></li>
            <li><a href="#contact" class="text-gray-400 hover:text-white transition-colors duration-200 font-body">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><span class="text-gray-400 font-body">Branding</span></li>
            <li><span class="text-gray-400 font-body">Consulting</span></li>
          </ul>
        </div>
      </div>

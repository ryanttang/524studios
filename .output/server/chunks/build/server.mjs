import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, shallowReactive, defineAsyncComponent, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, computed, toValue, mergeProps, getCurrentScope, watch, useSSRContext } from 'vue';
import { i as createError$1, R as defu, S as headSymbol, o as hasProtocol, T as isScriptProtocol, t as joinURL, U as withQuery, V as useHead$1, W as sanitizeStatusCode, X as getContext, $ as $fetch, Y as baseURL, Z as createHooks, _ as executeAsync, a0 as withoutTrailingSlash, a1 as titleCase, a2 as toRouteMatcher, a3 as createRouter$1, a4 as camelCase, G as withTrailingSlash, L as parseURL, a5 as withoutBase, a6 as useSeoMeta$1, a7 as stringifyQuery, a8 as withLeadingSlash, a9 as withBase, aa as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-RXWy_uQT.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BQVKC_Zv.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-B4hX33sb.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, createError as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, useOgImageRuntimeConfig as f, useSiteConfig as g, injectHead as i, navigateTo as n, resolveRouteObject as r, useHead as u };
